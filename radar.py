...
objects = [[0,0],[10,0],[20,70],[30,0],[40,0],[50,0],[60,0],[70,0],[80,0],
               [90,0],[100,0],[110,0],[120,0],[130,0],[140,200],[150,0],[160,0],
               [170,150],[180,0]]
...
def drawObject(angle, distance):
    ...
    canvas.create_oval(x-5,y-5,x+5,y+5,fill='green')#oval = 원 그리는 명령어 

def updateScan():
    global angle#전역변수 함수내에사 사용하기 위해 global 선언, Update 되기 때문에
    global direction
    global objects
    global sendingAngle
    receiveDistance = 0
